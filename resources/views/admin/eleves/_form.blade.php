@props(['eleve', 'villes', 'action', 'method' => 'POST', 'cancelUrl' => null])
...
<form method="POST" action="{{ $action }}" class="bg-white p-6 rounded-lg shadow-sm space-y-4 max-w-3xl">
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ $cancelUrl ?? route('admin.eleves.index') }}" class="px-4 py-2 text-gray-600 hover:text-gray-800">Annuler</a>
    </div>
</form>
