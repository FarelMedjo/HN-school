<x-admin-layout>
    <x-page-header title="Nouveau parent" />
    <form method="POST" action="{{ route('admin.parents.store') }}" class="bg-white p-6 rounded-lg shadow-sm space-y-4 max-w-3xl">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">Enfant *</label>
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.parents.index') }}" class="px-4 py-2 text-gray-600 hover:text-gray-800">Annuler</a>
        </div>
    </form>
</x-admin-layout>
