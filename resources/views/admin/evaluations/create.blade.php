<x-admin-layout>
    ...
    <form method="POST" action="{{ route('admin.evaluations.store') }}" class="bg-white p-6 rounded-lg shadow-sm space-y-4 max-w-2xl">
        @csrf
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.evaluations.index') }}" class="px-4 py-2 text-gray-600 hover:text-gray-800">Annuler</a>
        </div>
    </form>
</x-admin-layout>
