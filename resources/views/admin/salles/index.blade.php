<x-admin-layout>
    <x-page-header title="Salles" :createRoute="route('admin.salles.create')" createLabel="Nouvelle salle" />
                ...
                @forelse ($salles as $s)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2">
                            <a href="{{ route('admin.salles.edit', $s) }}" class="text-sky-600 hover:underline">Éditer</a>
                            <form method="POST" action="{{ route('admin.salles.destroy', $s) }}" class="inline"
