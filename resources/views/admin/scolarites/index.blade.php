<x-admin-layout>
    <x-page-header title="Scolarités" :createRoute="route('admin.scolarites.create')" createLabel="Nouvelle scolarité" />
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($scolarites as $s)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2">
                            <a href="{{ route('admin.scolarites.edit', $s) }}" class="text-sky-600 hover:underline">Éditer</a>
                            <form method="POST" action="{{ route('admin.scolarites.destroy', $s) }}" class="inline"
                ...
                @empty
                    <tr><td colspan="6" class="px-4 py-6 text-center text-gray-500">Aucune scolarité.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
