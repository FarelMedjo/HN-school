<x-admin-layout>
    ...
    <form method="POST" action="{{ route('admin.paiements.store') }}" class="bg-white p-6 rounded-lg shadow-sm space-y-4 max-w-3xl">
        @csrf
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.paiements.index') }}" class="px-4 py-2 text-gray-600 hover:text-gray-800">Annuler</a>
        </div>
    </form>
</x-admin-layout>
