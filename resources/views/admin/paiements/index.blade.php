<x-admin-layout>
    <x-page-header title="Paiements" :createRoute="route('admin.paiements.create')" createLabel="Enregistrer un paiement" />
                ...
                @forelse ($paiements as $p)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right">
                            <form method="POST" action="{{ route('admin.paiements.destroy', $p) }}" class="inline"
