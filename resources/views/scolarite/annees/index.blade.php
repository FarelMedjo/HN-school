<x-scolarite-layout>
    <x-page-header title="Années académiques" subtitle="Gestion des années scolaires"
                   :createRoute="route('scolarite.annees.create')" createLabel="Nouvelle année" />
                ...
                @forelse ($annees as $a)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2">
                            <a href="{{ route('scolarite.annees.edit', $a) }}" class="text-sky-600 hover:underline">Éditer</a>
                            <form method="POST" action="{{ route('scolarite.annees.destroy', $a) }}" class="inline"
