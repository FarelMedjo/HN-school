<x-scolarite-layout>
    <x-page-header title="Élèves" :createRoute="route('scolarite.eleves.create')" createLabel="Nouvel élève" />
    ...
    <form method="GET" class="mb-4 flex gap-2">
        ...
        <button class="px-4 py-2 bg-amber-800 text-white rounded-md text-sm">Rechercher</button>
    </form>
                ...
                @forelse ($eleves as $e)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2">
                            <a href="{{ route('scolarite.eleves.show', $e) }}" class="text-emerald-600 hover:underline">Voir</a>
                            <a href="{{ route('scolarite.eleves.edit', $e) }}" class="text-sky-600 hover:underline">Éditer</a>
                            <form method="POST" action="{{ route('scolarite.eleves.destroy', $e) }}" class="inline"
