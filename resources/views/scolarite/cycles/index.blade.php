<x-scolarite-layout>
    <x-page-header title="Cycles" subtitle="Niveaux scolaires de l'établissement"
                   :createRoute="route('scolarite.cycles.create')" createLabel="Nouveau cycle" />
                ...
                @forelse ($cycles as $c)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2">
                            <a href="{{ route('scolarite.cycles.edit', $c) }}" class="text-sky-600 hover:underline">Éditer</a>
                            <form method="POST" action="{{ route('scolarite.cycles.destroy', $c) }}" class="inline"
