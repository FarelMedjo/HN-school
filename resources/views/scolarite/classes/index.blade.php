<x-scolarite-layout>
    <x-page-header title="Classes" :createRoute="route('scolarite.classes.create')" createLabel="Nouvelle classe" />
                ...
                @forelse ($classes as $c)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2">
                            <a href="{{ route('scolarite.classes.edit', $c) }}" class="text-sky-600 hover:underline">Éditer</a>
                            <form method="POST" action="{{ route('scolarite.classes.destroy', $c) }}" class="inline"
