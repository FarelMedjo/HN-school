...
class EleveController extends Controller
{
    public function index(Request $request)
    {
        ...
        $eleves = Eleve::with('villeNaissance')
            ...
            ->paginate(15)
            ->withQueryString();
        return view('scolarite.eleves.index', compact('eleves', 'q'));
    }

    public function create()
    {
        return view('scolarite.eleves.create', [
            'eleve' => new Eleve(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('scolarite.eleves.index')->with('success', 'Élève créé.');
    }
    ...
    public function show(Eleve $eleve)
    {
        ...
        return view('scolarite.eleves.show', compact('eleve', 'salles', 'annees'));
    }

    public function edit(Eleve $eleve)
    {
        return view('scolarite.eleves.edit', [
            'eleve' => $eleve,
            'villes' => VilleNaissance::orderBy('libelle')->get(),
        ]);
    }
    ...
    public function update(Request $request, Eleve $eleve)
    {
        ...
        return redirect()->route('scolarite.eleves.index')->with('success', 'Élève mis à jour.');
    }

    public function destroy(Eleve $eleve)
    {
        $eleve->delete();
        return redirect()->route('scolarite.eleves.index')->with('success', 'Élève supprimé.');
    }
